<template>
  ...
  >
    <view
      class="he-poster flex justify-center align-center"
      @touchmove.stop.prevent="() => {}"
      :data-theme="theme"
    >
      <view class="he-poster__box" v-if="!loading">
        <view
          class="he-poster__close flex align-center justify-center"
        ...
        <view>
          ...
          ></image>
          <!-- #ifndef H5 -->
          <button class="he-poster__save cu-btn" @click="saveImage">
            保存图片
          </button>
          <!-- #endif -->
          <!-- #ifdef H5 -->
