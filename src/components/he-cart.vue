  ...
  <he-popup v-model="showModal" :border-radius="16" mode="bottom">
    <view class="he-cart" :data-theme="theme">
      <view class="he-cart__header">
        <view
          class="he-close flex justify-center align-center"
      ...
      <scroll-view scroll-y class="he-cart__body">
        <view class="he-attr">
          <view class="he-item" v-for="(item, index) in showParam" :key="index">
            ...
            <view
              class="he-item__body flex flex-wrap"
      ...
      <view class="he-cart__footer">
        <view
          class="he-footer__btn"
          :class="$h.test.isEmpty(shoppingType) ? 'flex justify-between' : ''"
        >
          ...
          <button
            v-if="stocks === 0"
            class="cu-btn he-btn he-sure-btn"
            disabled
          >
            商品已售罄
          </button>
