<template>
    <view class="he-page-content">
        <he-tabs ref="tabs" :list="tabs" :bar-height="4" :tabs-style="{ position: 'fixed', top: 0, width: '100%', zIndex: 2 }" :bar-bottom="24" :active-color="themeColor" :bold="false" bg-color="#F5F5F5" :height="114" :is-scroll="false" @change="change" :current="current"></he-tabs>
...
export default {
    ...
    methods: {
        setTab: function(callBack) {
            ...
            const request = this.getList().then(function(res) {
                _this.loading = false;
                _this.list = res;
