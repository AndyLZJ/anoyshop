<template>
    <view class="he-page-content" :class="loading ? 'flex justify-center align-center' : ''">
        ...
        <template v-else>
            ...
            <submit-price :goods-amount="detail.goods_amount" :freight-amount="detail.freight_amount" :goods-data="detail.goods_data" @apply="couponPreview" :coupon-reduced="detail.coupon_reduced" :user-coupon-id="userCouponId"></submit-price>
