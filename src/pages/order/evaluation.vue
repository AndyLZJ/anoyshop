        ...
        <view class="he-content" v-for="(good, index) in detail.goods" :key="index">
            ...
            <view class="he-body">
                ...
                <view class="he-evaluation">
                    <textarea class="he-textarea" placeholder-style="font-size:26rpx;font-family: PingFang SC;font-weight: 500; color: #999999; line-height:1.3;" placeholder="说说你的购买体验，为更多小伙伴提供有价值的参考吧。" :maxlength="300" :value="form[index].content" @input="(e) => setTextarea(e, index)"></textarea>
                    <view class="he-prompt flex"  v-if="form[index]">
                        ...
                        <view class="he-min" v-if="form[index].content.length < 10">
                            再输入
                            <text class="he-number">{{
                                10 - form[index].content.length
                                }}</text>
                            个字就能发表了哦
                        </view>
                    </view>
            ...
            <view class="he-footer"  v-if="form[index]">
                ...
                <view class="he-bottom">
                    <he-upload-image :index="index" :sizeType="['compressed']" @on-remove="removeImage" @on-uploaded="uploaded" :max-count="6" :max-size="getPicLimit"></he-upload-image>
                </view>
            </view>
        </view>
