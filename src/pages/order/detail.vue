<template>
    <view class="he-page-content" :class="loading ? 'flex justify-center align-center' : ''">
        ...
        <template v-if="!loading">
            <detail-top :status="detail.status" :created-time="detail.created_time" :received-time="detail.received_time" :after-sales="detail.after_sales"></detail-top>
            ...
            <detail-bottom-operating v-if="isBottom" :order-sn="detail.order_sn" :order-id="detail.id" :pay-amount="detail.pay_amount" :total-amount="detail.total_amount" :is-evaluate="detail.is_evaluate" :status.sync="detail.status">
