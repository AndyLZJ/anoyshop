    ...
    <view class="he-page-content" :data-theme="theme">
        <view class="he-box">
            <view class="he-item flex align-center" @click="navigateTo">
                ...
                <view class="flex-sub flex align-center justify-between">
                    <view class="he-placeholder" :class="user_freight_info.logistics_company ? 'he-is-name' : ''">{{
                        user_freight_info.logistics_company
                        ? user_freight_info.logistics_company
                        : "请填写物流公司"
                        }}</view>
            ...
            <view class="he-item flex align-center">
                ...
                <input type="text" class="he-item__input flex-sub" onkeyup="user_freight_info.freight_sn=user_freight_info.freight_sn.replace(/[^\d]/g,'')" maxlength="20" v-model="user_freight_info.freight_sn" placeholder-class="he-placeholder" placeholder="请填写物流单号" />
            </view>
        </view>
        <!--上传凭证-->
...
export default {
    ...
    computed: {
        isSubmit: function() {
            return (
                !this.user_freight_info.logistics_company ||
                !this.user_freight_info.freight_sn
            );
        },
    },
    data() {
    ...
    methods: {
        ...
        navigateTo: function() {
            uni.redirectTo({
                url: "/pages/other/logisticsCompany?id=" +
                    this.id +
                    "&mobile=" +
