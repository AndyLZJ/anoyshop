    ...
    <view class="he-page-content">
        <view class="he-top">
            ...
            <view class="flex flex-wrap" :data-theme="theme">
                <view class="he-tab__item" @click="setTab(item.key)" v-for="(item, index) in tabs" :class="tabKey === item.key ? 'he-tab__item-1' : 'he-tab__item-0'" :key="index">
            ...
            <view class="he-item" v-for="item in list" :key="item.id">
                <view class="he-item__header flex align-center justify-between">
                    ...
                    <view class="he-item__stars flex">
                        <!--#ifndef H5-->
                        <text v-for="num in 5" :key="num" class="iconfont iconevaluate_star" :class="item.star >= num + 1 ? 'he-star__1' : 'he-star__0'"></text>
                        <!--#endif-->
                        <!--#ifdef H5-->
                ...
                borderRadius: '8rpx',
              }" @click="doPreviewImage(img, item.images)" v-for="(img, imgIndex) in item.images" :key="imgIndex" :src="img"></he-image>
                    </view>
                    <view class="he-item__time">{{
                        $h.timeFormat(item.deleted_time)
                        }}</view>
                </view>
