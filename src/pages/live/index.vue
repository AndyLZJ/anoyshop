...
<template>
  <div class="wechatLive" :style="[backgroundColor]">
    <div class="le-body" :style="[bodyStyle]" :class="listStyle === 2 ? 'flex flex-wrap' : ''">
      <div
          class="le-item flex  "
          :class="[listStyle === 1 ? 'flex-direction le-item-one'
               : listStyle === 2 ? 'flex-direction le-item-two' : 'le-item-three']"
          :key="index"
          :style="[itemStyle]"
        ...
        <div class="le-content" :class="listStyle === 3 ? 'flex-sub' : ''">
          <div class="le-live-name">{{item.name}}</div>
          ...
          <div class="le-goods flex" v-if="showGoods && item.goods[0]">
            ...
            <div>
              <div class="le-name he-line-1">{{ item.goods[0].name }}</div>
              <div class="le-price">{{item.goods[0] | priceText}}</div>
            </div>
          </div>
        </div>
      </div>
