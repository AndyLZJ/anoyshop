    ...
    <view class="he-head">
      <view class="he-head--content flex">
        <view class="he-head--left flex align-center flex-sub">
          <he-image :image-style="{ borderRadius: '50%' }" class="he-image" :width="80" :height="80"></he-image>
          <view class="he-head--info">
            <view class="he-name">法外狂徒张三</view>
            <view class="he-shop">企码小店</view>
          </view>
        </view>
    ...
    <view class="he-body">
      <view class="he-card he-level flex justify-between">
        <view class="he-level--left">
          <view class="he-title">分销等级：白银</view>
          <view class="he-progress">
            <view :animation="animationData" class="he-progress--rate"></view>
          </view>
          <view class="he-prompt"> 升级至黄金，还需下线用户数152 </view>
        </view>
      ...
      <view class="he-card he-view">
        ...
        <view class="flex he-data-top">
          <view class="basis-df he-data--item">
            ...
            <view class="he-data--number">¥1206.50</view>
          </view>
          <view class="basis-df he-data--item">
            <view class="he-data--title">
            ...
            <view class="he-data--number">¥1809.75</view>
          </view>
        </view>
      ...
      <view class="he-card flex he-grand">
        <view class="flex-sub he-grand--item">
          ...
          <view class="he-grand--number"> 52454 </view>
        </view>
        <view class="flex-sub he-grand--item">
