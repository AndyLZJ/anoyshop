 ...
 * @Description: 
 * @Author: Qinuoyun
 * @Date: 2021-05-12 11:28:39
 * @LastEditTime: 2021-05-21 14:06:15
 * @LastEditors: fjt
 */
...
export const defaulter = {
    beforeEach(value, resolve, config) {
        //初始化变量
        let url, method, headers, argument, data, keys, page, parameter = null;
        //路由判断
...
export const POST = {
    beforeEach(value, resolve) {
        //初始化变量
        let url, headers, method, argument, data, keys, page = null;
        method = "POST";
        //路由判断
        let is_router = config.AppURL.indexOf("=") == -1 ? '?' : '&';
        //设置唯一Key
